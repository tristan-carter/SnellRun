...
export default function Home () {
  return (
    <>
      ...
      <main className="flex flex-col justify-between md:justify-center items-center min-h-screen max-h-screen bg-[#DF5644] md:bg-white">
        ...
        <p className="md:hidden z-[2] mt-40 font-bold text-white text-7xl">SnellRun</p>
